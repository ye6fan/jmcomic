...
- 问题0：别用android studio自带的虚拟机，可以使用MuMu模拟器之类的（速度快，调试方便，不容易卡死）
...
- 解决5：自己新创建一个flutter项目，直接复制我的lib目录去覆盖你的，复制我的pubspec.yaml覆盖你的
- 问题6：本项目的图片亮度没有原作者的亮，windows端观看时漫画图片之间有空隙，放大缩小的手势不灵敏（电脑端需要触摸屏才可以放大缩小）
- 解决6：未解决
