...
abstract class ComicPage<T> extends StatelessWidget {
  ...
  Iterable<Widget> buildEpisodeInfo(BuildContext context) sync* {
            ...
            child: InkWell(
              ...
              child: Material(
                ...
                child: Padding(
                  ...
                  child: Center(
                      child: Text(epsData!.eps[i],
                          maxLines: 1,
                          textAlign: TextAlign.center,
                          overflow: TextOverflow.ellipsis)),
                ),
              ),
              onTap: () => epsData!.onTap(i),
            ),
          );
        }),
    ...
    if (epsData!.eps.length > 20 && !_logic.showFullEps) {
      yield SliverToBoxAdapter(
          child: Align(
              ...
              child: FilledButton.tonal(
                      ...
                      child: Text('显示全部 ( ${epsData!.eps.length} )'))
                  .paddingTop(12)));
    }
  }
}
